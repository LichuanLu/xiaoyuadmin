...
angular.module('smartApp').factory('RequestsErrorHandler', ['$q', '$log', '$rootScope', 'httpErrorAction',
                ...
                if (shouldHandle) {
                    if (response.data && typeof response.data.errorCode !== 'undefined') {
                        ...
                        if (response.data.errorCode == 0) {
                            ...
                            httpErrorAction.messageErrorHandler(response);
...
angular.module('smartApp').config(['$provide', '$httpProvider',
